...
public class UserController extends ControllerBase {
	...
	public ResponseEntity<?> details() {
		try {
			...
			UserDTO result = userServiceImp.detail(username);
			String message = result != null ? "Get user details success" : "Get user details failed";
			ResponseDTO<UserDTO> response = new ResponseDTO<UserDTO>(message, result);

			return result != null ? ok(response) : notFound(response);
		} catch (Exception e) {
			String message = "Get user details error";
			ResponseDTO<String> response = new ResponseDTO<>(message, e.getMessage());
